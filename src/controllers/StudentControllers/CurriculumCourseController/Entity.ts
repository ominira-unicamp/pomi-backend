...
type PrismaCurriculumCoursePayload = MyPrisma.CurriculumCourseGetPayload<
    typeof prismaCurriculumCourseFieldSelection
>;

function buildCurriculumCourseEntity(
    curriculumCourse: PrismaCurriculumCoursePayload
): z.infer<typeof curriculumCourseEntity> {
...
const curriculumCourseEntity = z
    .object({
    ...
    .strict()
    .openapi("CurriculumCourseEntity");
