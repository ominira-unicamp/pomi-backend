...
const addCourse = {
    ...
    output: new OutputBuilder()
        .created(
            curriculumCourseEntity.schema,
            "Course added to curriculum successfully"
        )
        .badRequest()
        .notFound()
        .build()
...
const updateCourse = {
    input: z.object({
        ...
        body: curriculumCourseBase
            .omit({ curriculumId: true, courseId: true })
            .partial()
    }),
    output: new OutputBuilder()
